...
<%@page
	import="java.util.ArrayList,bean.Book,util.MyFormat,bean.OrderedItem"%>
<%
MyFormat mf = new MyFormat();
%>
<html>
<head>
<title>showHistoryOrderedItem</title>
</head>
<body>
	...
	<table style="margin: auto; width: 850px">
		<tr>
			...
			<td style="text-align: center; width: 508px; font-size: 24px;">購入履歴</td>
